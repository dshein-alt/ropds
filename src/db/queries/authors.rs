...
pub async fn find_by_name(pool: &SqlitePool, full_name: &str) -> Result<Option<Author>, sqlx::Error> {
...
pub async fn get_for_book(pool: &SqlitePool, book_id: i64) -> Result<Vec<Author>, sqlx::Error> {
    sqlx::query_as::<_, Author>(
