...
pub async fn get_by_id(pool: &SqlitePool, id: i64) -> Result<Option<Genre>, sqlx::Error> {
...
pub async fn get_by_code(pool: &SqlitePool, code: &str) -> Result<Option<Genre>, sqlx::Error> {
...
pub async fn get_sections(pool: &SqlitePool) -> Result<Vec<String>, sqlx::Error> {
    let rows: Vec<(String,)> =
...
pub async fn get_by_section(pool: &SqlitePool, section: &str) -> Result<Vec<Genre>, sqlx::Error> {
...
pub async fn get_all(pool: &SqlitePool) -> Result<Vec<Genre>, sqlx::Error> {
...
pub async fn get_for_book(pool: &SqlitePool, book_id: i64) -> Result<Vec<Genre>, sqlx::Error> {
    sqlx::query_as::<_, Genre>(
