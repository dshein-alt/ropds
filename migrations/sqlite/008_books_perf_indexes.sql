...
-- Covering index for the global hide_doubles dedup subquery (SQLite implicitly
-- includes rowid/id in every secondary index):
...
CREATE INDEX idx_books_catalog_avail_title ON books(catalog_id, avail, search_title, author_key);
