...
**Поддерживаемые версии целевой БД** (проверено end-to-end):

| Backend    | Минимум | Примечания                                                            |
|------------|---------|-----------------------------------------------------------------------|
| PostgreSQL | 16+     | Проверено на 16 и 17.                                                 |
| MariaDB    | 11+     | Проверено на 11.x и 12.x.                                             |
| MySQL      | 8+      | Проверено на 8.4. Штатный SQL-режим `ONLY_FULL_GROUP_BY` подходит.    |
